...
function(OpenAsmSupport)
    ...
    # TODO
    set(CMAKE_ASM${ASM_DIALECT}_COMPILE_OBJECT "as <CMAKE_ASM${ASM_DIALECT}_LINK_FLAGS> -fPIE -o <OBJECT> <SOURCE>" PARENT_SCOPE)
    set(CMAKE_ASM${ASM_DIALECT}_CREATE_STATIC_LIBRARY
            "<CMAKE_AR> cr <TARGET> <LINK_FLAGS> <OBJECTS> "
            "<CMAKE_RANLIB> <TARGET> " PARENT_SCOPE)
    set(CMAKE_ASM${ASM_DIALECT}_LINK_EXECUTABLE
            "ld <FLAGS> <CMAKE_ASM${ASM_DIALECT}_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>" PARENT_SCOPE)
